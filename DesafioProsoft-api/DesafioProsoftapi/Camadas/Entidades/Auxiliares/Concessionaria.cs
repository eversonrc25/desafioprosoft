...
{
    [AtributoTabela(Nome = "Concessionaria", Esquema = "", TipoChave = eTipoChave.AutomaticaSequence)]
    public class Concessionaria : EntityBase, IEntityBase
    {

        [AtributoCampo(Nome = "conc_id_swat", TipoDado = DbType.String, TipoChave = eTipoChave.AutomaticaSequence)]
        public String Conc_id_swat { get; set; }

        [AtributoCampo(Nome = "conc_tx_descricao", TipoDado = DbType.String)]
        public String Conc_tx_descricao { get; set; }
